...
export default class NewClass extends cc.Component {
    ...
    init(data, idx) {
        ...
        NetEventDispatcher.addListener(NetEvent.S2CFamilyMallBuy, this.S2CFamilyMallBuy, this)
    ...
    onBuyHandler() {
        ...
        MyProtocols.send_C2SFamilyMallBuy(DataManager._loginSocket, this._idx, this.num)
    }

    onHideHandler() {
        this.node.active = false
        NetEventDispatcher.removeListener(NetEvent.S2CFamilyMallBuy, this.S2CFamilyMallBuy, this)
