...
var MyProtocols = {
	...
	send_C2SFamilyArmList(senderSocket, idx) {
		var myEncoder = WsEncoder.alloc();
		myEncoder.writeInt(13031);
	...
	get_13036: function (myDecoder) {
		var retObj = {};
		return retObj;
	},


	send_C2SEffectList(senderSocket, idx) {
		var myEncoder = WsEncoder.alloc();
		myEncoder.writeInt(13033);
